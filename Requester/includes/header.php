...
<body>
 ...
 <nav class="navbar navbar-dark fixed-top bg-danger flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="RequesterProfile.php">CS@D</a>
 </nav>
   ...
   <nav class="col-sm-2 bg-light sidebar py-5 d-print-none">
    <div class="sidebar-sticky">
     <ul class="nav flex-column">
      ...
      <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'viewtechnician') { echo 'active'; } ?>" href="viewtechnician.php">
        <i class="fas fa-align-center"></i>
        View Technician
       </a>
      </li>
       <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'contactform') { echo 'active'; } ?>" href="contactform.php">
